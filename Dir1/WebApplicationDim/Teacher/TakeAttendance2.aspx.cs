...
{
    public partial class TakeAttendance2 : System.Web.UI.Page
    {
        ...
        protected void gvTakeAttendence_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (cblCalssNumber.SelectedValue == "1")
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    {
                        CheckBox cbSelected = (CheckBox)e.Row.FindControl("cbSelected1");
        ...
        {
            Page.ClientScript.RegisterStartupScript(GetType(), "Scripts", "<script>alert('this is it :P');</scrip>");
